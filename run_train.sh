...
cd /gpfs/work/bio/yueqingxing22/igem/Plaszymer_ml
python train.py \
  --train_csv /gpfs/work/bio/yueqingxing22/igem/Plaszymer_ml/data/raw/PlaszymeDB_v1_sp_train_by_ids.csv \
  --work_dir  /gpfs/work/bio/yueqingxing22/igem/Plaszymer_ml/data/processed \
